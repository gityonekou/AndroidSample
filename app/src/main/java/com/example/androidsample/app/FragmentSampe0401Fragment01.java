...
public class FragmentSampe0401Fragment01 extends Fragment {
     ...
     * @return このインスタンス
     */
    public static FragmentSampe0401Fragment01 newInstance(int count) {
        FragmentSampe0401Fragment01 fragment = new FragmentSampe0401Fragment01();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        moveBtn.setOnClickListener( v -> {
            ...
            transaction.replace(R.id.fragment_sample0401_container,
                    FragmentSampe0401Fragment02.newInstance(this.counter));
            transaction.commit();
        });
        ...
        returnBtn.setOnClickListener( v -> {
            ...
            if(manager.getBackStackEntryCount() <= 1) {
                FragmentSampe0401 main = (FragmentSampe0401)getActivity();
